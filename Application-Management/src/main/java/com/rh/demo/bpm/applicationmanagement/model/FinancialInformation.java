...
public class FinancialInformation implements java.io.Serializable
{
   ...
   @javax.persistence.GeneratedValue(strategy = javax.persistence.GenerationType.AUTO, generator = "FINANCIALINFORMATION_ID_GENERATOR")
   @javax.persistence.Id
   @javax.persistence.SequenceGenerator(name = "FINANCIALINFORMATION_ID_GENERATOR", sequenceName = "FINANCIALINFORMATION_ID_SEQ")
