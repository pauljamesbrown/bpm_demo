...
public class IncomeDetails implements java.io.Serializable
{
   ...
   @javax.persistence.GeneratedValue(strategy = javax.persistence.GenerationType.AUTO, generator = "INCOMEDETAILS_ID_GENERATOR")
   @javax.persistence.Id
   @javax.persistence.SequenceGenerator(name = "INCOMEDETAILS_ID_GENERATOR", sequenceName = "INCOMEDETAILS_ID_SEQ")
